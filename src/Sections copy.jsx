...
function Sections() {
  return (
    <div>
      ...
      <section className="font-theme-text bg-secondary-gray  text-secondary-gray py-14 px-6 sm:px-12 xl:px-0">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            <div className="flex justify-start">
              <img className="h-full rounded-lg w-auto object-cover" src={image2} />
            </div>
            <div className="flex items-center">
              <div className="text-left px-2 sm:px-8 text-secondary-color">
                <div className="[&_strong]:font-semibold py-4 text-secondary-muted md:py-2">
                  <p className="uppercase">Metalworking</p>
                </div>
                <div className="font-theme-title text-3xl md:text-4xl [&_strong]:font-bold border-secondary-color text-secondary-marked">
                  <p>
                    <strong>
